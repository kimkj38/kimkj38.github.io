...
SSD에서는 다양한 scale과 aspect ratios를 사용한다고 하였다.  

![image](https://user-images.githubusercontent.com/76815825/117255221-5af73a80-ae84-11eb-804a-331c85da6f89.png) 

SSD는 다양한 크기의 feature map을 사용한다는 특징 때문에 작은 해상도(4x4)에서 큰 객체(개)를, 큰 해상도(8x8)에서 작은 객체(고양이)를 인식하게 된다.
